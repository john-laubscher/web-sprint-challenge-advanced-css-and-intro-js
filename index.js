...
function addArtist(array){
    array.push ({id: 20, name: "John", years: 1992-2021, genre: "Web Design", nationality: "White", bio: "He wasn't a very good artist."})
    return array
  }
...
function lotsOfArt(array){
  ...
  for(let i=0; i<array.length; i++){
    if(array[i].paintings>100){
     prolificNames.push(array[i].name)
    }
  }
  return prolificNames
}
